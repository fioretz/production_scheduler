            ...
            <div class="row">
                @foreach($macchina['ordiniproduzione'] as $ordine)
                    <div class="card col-4" style="width: 18rem; @if ($ordine['erroreScadenza']) background-color: #f9d6d5; @else background-color: #d7f3e3; @endif">
                        <div class="card-body">
                            @if ($ordine['erroreScadenza'])
                                <span title="Scadenza non rispettata"><i class="fa fa-exclamation-triangle badge-scadenza-errore" aria-hidden="true"></i></span>
                            @else
                                <span title="Scadenza rispettata"><i class="fa fa-check-circle badge-scadenza-ok" aria-hidden="true"></i></span>
                            @endif
